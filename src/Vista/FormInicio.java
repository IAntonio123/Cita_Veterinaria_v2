...
public class FormInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jmiMascota = new javax.swing.JMenuItem();
        ...
        jmiCliente.setText("Formulario Cliente");
        jMenu1.add(jmiCliente);

        jmiMascota.setText("Formulario Mascota");
        jMenu1.add(jmiMascota);

        jMenuBar1.add(jMenu1);

        jMenu2.setText("Citas");

        jmiCita.setText("Formulario Cita");
        jMenu2.add(jmiCita);

        jmiListaCitas.setText("Listado de Citas");
        jMenu2.add(jmiListaCitas);
    ...
    public javax.swing.JMenuItem jmiMascota;
